...
import al.binarytree.recursive.CompletenessOfBinaryTree2
import kotlin.test.Test
import kotlin.test.assertFalse
import kotlin.test.assertTrue

class CompleteBinaryTreeCheck2 {
    ...
    fun test11() {
        ...
        assertFalse { CompletenessOfBinaryTree2().isCompleteBinaryTree(tree) }
    }

    @Test
    fun test12() {
        val tree = generateTree1()
        assertTrue { CompletenessOfBinaryTree2().isCompleteBinaryTree(tree) }
    }
