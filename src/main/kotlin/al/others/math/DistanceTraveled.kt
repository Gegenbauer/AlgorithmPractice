...
class DistanceTraveled {
    fun distanceTraveled(mainTank: Int, additionalTank: Int): Int {
        var ans = 0
        var mainRest = mainTank
        var additionalRest = additionalTank
        var mainUsed = 0
        while (mainRest > 0) {
            ...
            mainRest--
            mainUsed++
            if (mainUsed == 5 && additionalRest > 0) {
                mainUsed = 0
                additionalRest--
                mainRest++
            }
    ...
    fun distanceTraveled2(mainTank: Int, additionalTank: Int): Int {
